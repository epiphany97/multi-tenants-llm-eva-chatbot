...
do
    ...
    aws s3 rm s3://model-eva-output-${t} --recursive
    aws s3 rb s3://model-eva-output-${t} --force
    aws s3 rm s3://model-eva-input-${t} --recursive
    aws s3 rb s3://model-eva-input-${t} --force
    aws s3 rm s3://rag-input-${t} --recursive
    aws s3 rb s3://rag-input-${t} --force
    aws s3 rm s3://rag-output-${t} --recursive
    aws s3 rb s3://rag-output-${t} --force
